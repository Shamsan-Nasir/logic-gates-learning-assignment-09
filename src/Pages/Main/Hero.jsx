        ...
        <div>
            ...
            <div className=" scrollbar-none overflow-hidden relative w-full h-[350px]  lg:h-[450px]">
                ...
                <div className='absolute z-20 p-12  w-full md:w-3/4 lg:w-1/2 h-full flex flex-col justify-center gap-3 items-center bg-black/50 md:bg-transparent '>
                    <h1 className='font-bold text-white text-3xl md:text-4xl lg:text-5xl text-center md:text-start '>Your Guide to the Planet's Sacred Spaces</h1>
                    <p className='text-sm md:text-base lg:text-lg text-white text-center md:text-start'>From high mountain treks to deep ocean dives, navigate the world's most pristine ecosystems with zero-impact, expert-led expeditions.</p>
                </div>
